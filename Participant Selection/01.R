...
ukb <- fread("/work/kylab/adanna/Aim1/673621/ukb673621.tsv", stringsAsFactors=F, data.table=F) #502,366
...
filtered <- as_tibble(import("/work/kylab/adanna/dPUFAcPUFA/gwis_files/filteredPheno2.tsv"))
...
geno <- as_tibble(read.table("/work/kylab/adanna/dPUFAcPUFA/gwis_files/chr11.sample", 
...
write_tsv(pheno, "/work/kylab/adanna/dPUFAcPUFA/gwis_files/main_initAssessment.tsv", quote="none")
write_csv(pheno, "/work/kylab/adanna/dPUFAcPUFA/gwis_files/main_initAssessment.csv", quote="none")
